...
class Mulitiselection(Payload):
    ...
    def post(self):
        return {"metricname": self.m_name,
                "content_partner": self.con_partner,
                "device_model": self.dev_model,
                "device_platform":self.dev_plat,
                "content_type": self.con_type,
                "cdn":self.cd_n,
                "location": self.lo_cation,
                "aggregation_interval":self.agg_interval}
